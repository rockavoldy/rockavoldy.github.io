<template>
  <Layout class="bg-gray-200">
    <main class="flex items-center h-screen">
      <div class="w-full sm:w-3/4 md:w-3/5 lg:w-3/5 max-w-xl mx-auto px-6 md:px-0 relative">
        <section class="mx-auto px-8 py-6 relative">
          <div class="bg-gray-100 shadow-xl rounded px-4 py-3 mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 797.46 814.59">
              <g id="Layer_2" data-name="Layer 2">
                <g id="vector">
                  ...
                  />
                  <ellipse style="fill: #dc8e6c;" cx="484.29" cy="123.03" rx="29.54" ry="47.77" />
                  <path
                  ...
                  />
                  <circle style="fill: #dc8e6c;" cx="501.26" cy="134.34" r="7.54" />
                </g>
              </g>
            </svg>

            <p
              class="font-serif my-4 leading-normal text-gray-700"
