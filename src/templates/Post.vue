  ...
  <Layout>
    ...
    <main>
      ...
      >
        ...
        >Tulisan ini sudah lebih dari satu tahun, informasi yang ada ditulisan ini mungkin sudah tidak relevan dengan versi yang sekarang.</alert>
  ...
  computed: {
    ...
    ogImageUrl() {
      return (
        ...
        `${this.config.siteUrl}/images/authors/default.png`
      );
    }
  }
};
